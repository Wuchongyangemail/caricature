...
import com.w.volunteer.pojo.common.ControlLine;
 ...
 * @Description
 * @Author wcy
 * @Date 2022/4/10 下午8:03
 **/
@Slf4j
public class RankExcelImport {
    /**
     * excel2007及以上版本
     *
     * @param file
     ...
     * @throws IOException
     */
    static List<Rank> xlsxImportExcel(MultipartFile file) throws IOException {
     ...
     * @throws IOException
     */
    static List<Rank> xlsImportExcel(MultipartFile file) throws IOException {
    ...
    public static List<Rank> importExcel(MultipartFile file) throws IOException {
